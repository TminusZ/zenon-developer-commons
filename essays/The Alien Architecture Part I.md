...
So it separated them with a dual ledger architecture.
...
1. User submits transaction to app frontend
2. Frontend sends it to centralized RPC endpoint
3. RPC node claims it was included
4. User trusts the response

You get:

1. User submits transaction directly to network
2. Browser receives Momentum commitment
3. Browser verifies inclusion cryptographically
4. User knows it was included, no trust required
